            ...
            <div class="product-item-filter row">
              <div class="col-12 col-sm-8 text-center text-sm-left">
                <div class="toolbar-sorter-right">
                  <span>Sort by </span>
                  <select id="sort-by" class="selectpicker show-tick form-control">
                  ...
                  <script>
                    ...
                    sortBy.addEventListener('change', function() {
                      if (sortBy.value === '1') {
                        ...
                        window.location.href = 'shopdesc.php';
                      } else if (sortBy.value === '3') {
                        window.location.href = 'shopasc.php';
                      }
                    });
                  </script>
                </div>
                      ...
                      <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                        <div class="products-single fix">
                          <div class="box-img-hover">
                            ...
                            <img src="images/<?= $produit['img']; ?>" class="img-fluid" alt="Image" />
                            <div class="mask-icon">
                              <ul>
                                <li>
        ...
        <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
          <div class="product-categori">
            ...
            <div class="filter-sidebar-left">
              ...
              $query = "SELECT * from categories where nomc like '%" . $_POST['search'] . "%' ";
              ...
              ?>
                ...
                <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                  <div class="list-group-collapse sub-men">
                    ...
                    <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1"><?= $row['nomc'] ?><small class="text-muted">(<?= $c->tot($row['idca']) ?>)</small>
                    </a>
