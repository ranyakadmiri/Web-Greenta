      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
          <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
            ...
            <li class="nav-item">
              <a class="nav-link" href="gallery.html">Offres d'emplois</a>
            </li>
            <li class="nav-item">
  ...
  <div class="cart-box-main">
    <div class="container">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td class="name-pr">
                        <a href="#"> <?php echo $item["nomp"]; ?></a>
                      </td>
                      <td class="price-pr">
                        <p><?php echo $item["prix"] . ' DT'; ?></p>
                      </td>
                      <td>
                        <input id="q" type="number" value="<?php echo $item["quantite"]; ?>" min=" 0 " step="1" class="c-input-text qty text" />
                      </td>
                      <td class="total-pr">
                        <p><?php echo $item["subtotal"] . ' DT'; ?></p>
                      </td>
                      <td class="remove-pr" onclick="return confirm('Vous etes sur ?')">
                        <a href="cartaction.php?action=removeCartItem&idpr=<?php echo $item["rowid"]; ?>"><i class="fas fa-times"></i>
                        </a>
                      </td>
                    </tr>
                  <?php }
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Vérifie si le code de réduction a été envoyé
        if (!empty($_POST["discount_code"])) {
          $discount_code = $_POST["discount_code"];
          $cart->apply_discount($discount_code); // applique une réduction de 10%
        }
      }
      ?>
      <div class="row my-5">
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="coupon-box">
              <div class="input-group input-group-sm">
                <input class="form-control" placeholder="Enter your coupon code" type="text" name="discount_code" id="discount_code" />
      ...
      <div class="row my-5">
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="order-box">
            ...
            <div class="d-flex gr-total">
              <?php if ($cart->total_items() > 0) { ?>
                <h5>Grand Total</h5>
                <div class="ml-auto h5"><?php echo $cart->total() . ' DT'; ?></div>
            </div>
          <?php } ?>
          <hr />
          </div>
        ...
        <div class="col-12 d-flex shopping-box">
          <a href="checkout.html" class="ml-auto btn hvr-hover">valider</a>
          ...
          <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="footer-link-contact">
              ...
              <ul>
                <li>
                  <p>
                    <i class="fas fa-map-marker-alt"></i>Address: Michael
                    I. Days 3756 <br />Preston Street Wichita,<br />
                    KS 67213
                  </p>
                </li>
                <li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="our-link">
            <ul>
              ...
              <li>
                <a href="#"><i class="fas fa-location-arrow"></i> Our location</a>
              </li>
              <li>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="text-slid-box">
            <div id="offer-box" class="carouselTicker">
              <ul class="offer-box">
                <li>
                  <i class="fab fa-opencart"></i> 10% off Entire Purchase
                  Promo code: SUMMER10
                </li>

                <li>
                  <i class="fab fa-opencart"></i> 15% off Entire Purchase
                  Promo code: FALL15
                </li>
                <li><i class="fab fa-opencart"></i> Off 20%! Shop Now Promo code: WINTER20</li>
              </ul>
            </div>
          </div>
        </div>
