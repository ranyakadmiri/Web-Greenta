                        ...
                        <div class="products-single fix">
                          <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                              ...
                              <a class="cart" href="cartaction.php?action=addToCart&idpr=<?= $produit['idpr'] ?>">Ajouter au panier</a>
            ...
            <div class="filter-sidebar-left">
              ...
              <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                <?php foreach ($tab1 as $categorie) { ?> <div class="list-group-collapse sub-men">
                    ...
                    <a href="aff.php?idca=<?= $categorie['idca'] ?>"><?= $categorie['nomc'] ?><small class="text-muted">(<?= $c->tot($categorie['idca']) ?>)</small>
                    </a>
