      ...
      <li class="text-center">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1 class="m-b-20">
                <strong>fel page hedhy juste nhottou short description lel website
                  ou les offres <br />
                </strong>
              </h1>
              <p class="m-b-40">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="shop-cat-box">
            ...
            <a class="btn hvr-hover" href="#">hedhouma zeydin ama well keep them just in case</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="shop-cat-box">
            <img class="img-fluid" src="images/categories_img_02.jpg" alt="" />
            <a class="btn hvr-hover" href="#">blabla</a>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="shop-cat-box">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="title-all text-center">
            <h1>section mtaa l products that you can buy or rent</h1>
            <p>
              just a shot description ou maybe display mtaa some items ken
              aana lwakt
            </p>
          </div>
        </div>
  ...
  <div class="latest-blog">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="title-all text-center">
            <h1>section aala contacting les invesstiseurs ou koll</h1>
            <p>
              short description ou kahaw nothing crazy for l section mtaa job
              offers we'll just copy the code ou naamlouh fard style que this
              one
            </p>
          </div>
        </div>
