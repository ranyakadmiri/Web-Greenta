  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 mb-4">
        <br><br>
        <h1 class="text-center">List des Investissements</h1>
        <br>
      </div>
    </div>
    <div class="row">
      <?php foreach ($tab as $investissement) { ?>
        <div class="col-md-4 mb-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><?= $investissement['firstName'] . ' ' . $investissement['lastName'] ?></h5>
              <p class="card-text"><?= $investissement['adress'] ?></p>
              <p class="card-text"><?= $investissement['dob'] ?></p>
              <p class="card-text"><?= $investissement['category'] ?></p>
            </div>
          </div>
        </div>
      <?php } ?>
