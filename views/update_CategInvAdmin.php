...
if (
  ...
  if (
    ...
    $categoryInvC->update_category($categoryInv, $_POST["idCateg"]);
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        if (isset($_POST['idCateg'])) {
          $categ = $categoryInvC->show_category($_POST['idCateg']);

        ?>

          <form action="" method="POST" onsubmit="return verif();">
            <table align="center">
              <h2 align="center">Modifier Catégorie</h2>
              <tr>
                <td>
                  <label for="idinv">ID:
                  </label>
                </td>
                <td><input type="text" name="idCateg" id="idinv" value="<?php echo $categ['idCateg']; ?>" maxlength="20"></td>
              </tr>
              <tr>
                <td>
                ...
                <td><input type="text" name="nomCateg" id="firstName" value="<?php echo $categ['nomCateg']; ?>" maxlength="20"></td>
              </tr>
              <tr>
                <td>
                  <label for="lastName">Description Catégorie:
                  </label>
                </td>
                <td><textarea name="descriptionCateg"><?php echo $categ['descriptionCateg']; ?></textarea>
              </tr>
        ...
        transition: background-color 0.3s ease; background-color: green;" type="submit" value="Update">
                </td>
                <td>
                  <input style="      background-color: #007bff;
        border: none;
