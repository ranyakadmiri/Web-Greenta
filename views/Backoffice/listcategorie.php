<?php
include 'C:\xampp\htdocs\backend\controller\categorieC.php';
include 'C:\xampp\htdocs\backend\model\categorie.php';
      ...
      <main>
        ...
        <table border="1" align="center" width="70%">
          ...
          ?>
            ...
            <tr>
              <td><?= $categorie['idca']; ?></td>
              <td><?= $categorie['nomc']; ?></td>

              <td align="center">
                <form method="POST" action="updatecategogie.php">
                  <input type="submit" name="update" value="Update" />
                  <input type="hidden" value=<?PHP echo $categorie['idca']; ?> name="idca">
                </form>
              </td>
              <td>
                <a href="deletecategorie.php?idca=<?php echo $categorie['idca']; ?>">delete</a>
              </td>
            </tr>
          <?php
          }
