  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 mb-4">
        <br><br>
        <h1 class="text-center">List des Catégorie Investissement</h1>
        <br>
      </div>
    </div>
    <div class="row">
      <?php foreach ($tab as $categ) { ?>
        <div class="col-md-4 mb-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><?= $categ['nomCateg'] ?></h5>
              <p class="card-text"><?= $categ['descriptionCateg'] ?></p>
            </div>
          </div>
        </div>
      <?php } ?>
