  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <center>
          <br><br>
          <h1>List des Catégories Investissement</h1>
          <br>
        ...
        <table border="1" align="center" width="70%">
          ...
          ?>
            ...
            <tr>
              <td><?= $categ['idCateg']; ?></td>
              <td><?= $categ['nomCateg']; ?></td>
              <td><?= $categ['descriptionCateg']; ?></td>
              <td align="center">
                <form method="POST" action="update_CategInvAdmin.php">
        ...
        text-align: center;
        text-decoration: none;
        transition: background-color 0.3s ease; background-color: red;" href="delete_CategInvAdmin.php?id=<?php echo $categ['idCateg']; ?>">Delete</a>
              </td>
            </tr>
          <?php
          }
        ...
        <center>
          <h5>
            <a href="add_CategInvAdmin.php">Ajouter Catégorie Investissement</a>
          </h5>
        </center>
