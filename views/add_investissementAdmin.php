...
if (
  ...
  if (
    ...
    $investissementc->add_investissement($investissement);
    $investissementc->sendSMS();
    ...
    <div id="layoutSidenav_content">
      <main>
        ...
        <form action="" method="POST" onsubmit="return verif();">
          <table align="center">
            <br>
            <h2 align="center">Ajouter Investissement</h2>
            <br>
            ...
            <tr>
              ...
              <td>
                <select type="category" id="category" name="category">
        ...
        transition: background-color 0.3s ease; background-color: green;" onclick="verif()" type="submit" value="Save">
              </td>
              <td>
                <input style="      background-color: #007bff;
        border: none;
