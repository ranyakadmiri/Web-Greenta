...
<html lang="en">
  ...
  <div>
                      <img src="../images/barcha_amiret.jpeg" alt="" style="position:absolute;">
                    </div>
    <div id="layoutAuthentication" >
    
      <div id="layoutAuthentication_content">
        <main>
          <div class="container bagra">
            <div class="row justify-content-center">
              <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  ...
                  <div class="card-body bagra">
                    
                    <form action="../connexion.php" method="POST"  class="bagra">
