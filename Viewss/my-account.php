...
include "../config2.php";
    ...
    // $verifuser = $pdo -> query('SELECT * FROM user where email="'$_SESSION['mail']'"');
  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="our-link">
              <ul>
                <li>
                  <a href="back/login.php"><i class="fa fa-user s_color"></i> My Account</a>
                </li>
                <li>
                  <a href="#"
                ...
                <li>
                  <a href="back/logout.php"><i class='fas fa-sign-out-alt'></i> Deconnexion</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      >
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html" style="color: #77b81e"
              ><img src="images/logo.jpg" class="logo" alt="" />GreenTa</a
            >
          </div>
          ...
          <div class="attr-nav">
            <ul>
              ...
              <a href="back/logout.php">
                  ...
                  <p><i class="fa fa-lock"></i>Deconnexion</p>
                </a>
              </li>
            </ul>
          </div>
    ...
    <div class="all-title-box">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2><li class="">Welcome <?php echo $_SESSION['name'];    ?></li></h2>
            <ul class="breadcrumb">
          ...
          <div class="row">
              ...
              <div class="account-box">
                <div class="service-box">
                  <div class="service-icon">
                    <a href="about.html">   <i style='font-size:24px' class='fas'>&#xf201;</i>
 </a>
                  </div>
            ...
            <div class="col-lg-4 col-md-12">
              <div class="account-box">
                <div class="service-box">
                  <div class="service-icon">
                   <?php echo "  <a href='back/midifyuser.php?varname=".$_SESSION['mail']."' >  <i class='fa fa-lock'></i> </a>  "  ;?>
